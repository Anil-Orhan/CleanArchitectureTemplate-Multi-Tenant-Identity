        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    SourceRoleGroupId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleGroups_RoleGroups_SourceRoleGroupId",
                        column: x => x.SourceRoleGroupId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleGroups_SourceRoleGroupId",
                table: "RoleGroups",
                column: "SourceRoleGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleGroups_TenantId",
                table: "RoleGroups",
                column: "TenantId");
